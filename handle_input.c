 ...
 * Return: bytes read
 */
ssize_t input_buf(in_formations *info, char **buf, size_t *len)
{
	ssize_t r = 0;
	size_t len_p = 0;
 ...
 * Return: bytes read
 */
ssize_t get_input(in_formations *info)
{
 ...
 * Return: r
 */
ssize_t read_buf(in_formations *info, char *buf, size_t *i)
{
	ssize_t r = 0;
 ...
 * Return: s
 */
int scanit(in_formations *info, char **ptr, size_t *length)
{
